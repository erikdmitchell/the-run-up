 ...
 * License URI: http://www.gnu.org/licenses/gpl-2.0.txt
 ...
 2.1.0 - added ability to handle drop down menus via erikdmitchell
 */

/* Check if Class Exists. */
if ( ! class_exists( 'tru_wp_bootstrap_navwalker' ) ) {

    class tru_wp_bootstrap_navwalker extends Walker_Nav_Menu {
